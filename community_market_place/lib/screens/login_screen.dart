...
import 'package:communitymarketplace/screens/signup_screen.dart';
import 'package:communitymarketplace/themes/design_theme.dart';
import 'package:communitymarketplace/values/values.dart';
import 'package:communitymarketplace/widgets/custom_shape_clippers.dart';
import 'package:communitymarketplace/widgets/custom_text_form_field.dart';
import 'package:communitymarketplace/widgets/spaces.dart';
                    ...
                    Expanded(
                      child: ListView(
                        children: <Widget>[
                          ...
                          Container(
                            margin:
                                EdgeInsets.only(left: (widthOfScreen * 0.55)),
                            child: Text(
